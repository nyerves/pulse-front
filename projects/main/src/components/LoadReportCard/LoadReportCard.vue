...
<template>
  <div class="card shadow-md border border-gray-200 w-[44rem]">
    ...
    <h4 class="text-center !text-bold !mb-7">
      {{ reportStep === 'loaded' ? 'Carga de' : 'Resumen' }} {{ props?.title }}
    </h4>
      ...
      <div id="view-container">
        ...
        <div v-else>
          ...
          <div id="report-header-card" class="mb-8">
            ...
            <div id="daily-header-card" class="bg-gray-50 p-4 rounded-lg border border-gray-200">
              <dl class="grid grid-cols-2 sm:grid-cols-3 gap-x-6 gap-y-3 text-sm">
                ...
                <div>
                  ...
                  <dd class="font-semibold text-gray-800">{{ props.frequency }}</dd>
                </div>
          ...
          >
            <div class="flex items-center gap-4">
              ...
              <p id="filename-loaded" class="font-semibold text-left truncate">
                {{ fileXlsx?.name }}
              </p>
            </div>
          </div>
          ...
          <div v-else-if="reportStep === 'progress'">
            <div class="flex items-center gap-4 mb-4">
              ...
              <p id="filename-progress" class="truncate">
